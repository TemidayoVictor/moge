...
const Cta = () => {
    return (
        <div className="text-center px-[10%] py-[3em] bg-blue-900 bg-opacity-20">
            <h2 className="inline-block font-bold text-[2rem] border-b-4 border-slate-500">Get <span className="text-blue-300">SportyBook</span> Now !</h2>
            <p className="mt-2 text-[1.3rem]">Discover the Future of Sports Betting</p>
            <div>
