...
const Future = () => {
    return (
        <div className="px-[10%] py-[3em] mt-4 flex items-center justify-between bg-purple-900 bg-opacity-20 max-lg:flex-col-reverse max-lg:px-[5%]">
            {/* <div className="left grid grid-cols-1 gap-3 w-[40%] max-lg:w-[100%]">
                <Image 
            ...
            <div className="right w-[100%] max-lg:w-[100%]">
                ...
                <div className="mt-5 flex flex-col gap-8">
                    ...
                    <div className="flex gap-2 items-center justify-center border-gray-700 max-lg:flex-col"> 
                        <p className="text-[1.1rem] "><strong className="text-[1.3rem]"></strong> 
