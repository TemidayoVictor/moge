            ...
            <div className="grid max-lg:grid-cols-1 grid-cols-3 gap-6 my-[1em] mt-5">
                ...
                <div className="bg-orange-900 bg-opacity-20 py-8 border border-transparent flex flex-col gap-3 rounded-[.5em] hover:border hover:border-orange-300">
                    ...
                    <p className="text-[.9rem] tracking-wide px-4">
                        Swiftly detect and execute transactions on hot token launches, ensuring 
                ...
                <div className="bg-orange-900 bg-opacity-20 py-8 border border-transparent flex flex-col gap-3 rounded-[.5em] hover:border hover:border-orange-300">
                    ...
                    <p className="text-[.9rem] tracking-wide px-4">
                        Trade Instantly on Uniswap's DEX Platform with low fees and no
                        intermediaries. Optimize your strategies effortlessly
                    </p>
                </div>
                ...
                <div className="bg-orange-900 bg-opacity-20 py-8 border border-transparent flex flex-col gap-3 rounded-[.5em] hover:border hover:border-orange-300">
                    ...
                    <p className="text-[.9rem] tracking-wide px-4">
                        Set buying/selling prices in advance, and SportyBet Bot will execute trades when conditions
                        are met.
                    </p>
                </div>
                ...
                <div className="bg-orange-900 bg-opacity-20 py-8 border border-transparent flex flex-col gap-3 rounded-[.5em] hover:border hover:border-orange-300">
                    ...
                    <p className="text-[.9rem] tracking-wide px-4">
                       Customize trading strategies with precision. Let SportyBook Bot execute your 
                       personalized plan
                    </p>
                </div>
                ...
                <div className="bg-orange-900 bg-opacity-20 py-8 border border-transparent flex flex-col gap-3 rounded-[.5em] hover:border hover:border-orange-300">
                    ...
                    <p className="text-[.9rem] tracking-wide px-4">
                        Amplify gains with leverage, but trade responsibly as it involves higher risks
                    </p>
                </div>
                ...
                <div className="bg-orange-900 bg-opacity-20 py-8 border border-transparent flex flex-col gap-3 rounded-[.5em] hover:border hover:border-orange-300">
                    ...
                    <p className="text-[.9rem] tracking-wide px-4">
                        Diversify trading options and access a wide range of tokens seamlessly
                    </p>
                </div>
                ...
                <div className="bg-orange-900 bg-opacity-20 py-8 border border-transparent flex flex-col gap-3 rounded-[.5em] hover:border hover:border-orange-300">
                    ...
                    <p className="text-[.9rem] tracking-wide px-4">
                        Follow strategies of successful traders automatically. Learn and earn from the best
                    </p>
                </div>
                ...
                <div className="bg-orange-900 bg-opacity-20 py-8 border border-transparent flex flex-col gap-3 rounded-[.5em] hover:border hover:border-orange-300">
                    ...
                    <p className="text-[.9rem] tracking-wide px-4">
                        Ensure transaction privacy and fund protection with our wallet mixer feature
                    </p>
                </div>
                ...
                <div className="bg-orange-900 bg-opacity-20 py-8 border border-transparent flex flex-col gap-3 rounded-[.5em] hover:border hover:border-orange-300">
                    ...
                    <p className="text-[.9rem] tracking-wide px-4">
                        Safegurd investments with our advanced algorithm that detects potential <scams></scams>
                    </p>
                </div>
